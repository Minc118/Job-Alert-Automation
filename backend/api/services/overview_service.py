...
def get_overview(user_id: str, *, range_name: str = "latest_run") -> OverviewResponse:
    validate_user_id(user_id)
    jobs = list_jobs(user_id, range_name=range_name, limit=100)
    latest_run = get_latest_run(user_id)
